...
Report unacceptable behavior by opening an issue or starting a discussion in the repository. For sensitive matters, you may optionally create a private GitHub security advisory (if enabled for this repo).
